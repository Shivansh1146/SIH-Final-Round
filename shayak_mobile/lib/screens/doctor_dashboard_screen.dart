            ...
            return Wrap(
              ...
              children: [
                ...
                _buildKpiCard(
                  ...
                  value: _activePatientId == 'patient-monalisa' ? '92/100' : '84/100',
                  subtitle: _activePatientId == 'patient-monalisa' ? 'Normal motor baseline' : 'ESP32 Bio-sensor live',
                ...
                _buildKpiCard(
                  ...
                  value: _activePatientId == 'patient-monalisa' ? '5 pauses' : (_activePatientId == 'patient-tenzin' ? '2 pauses' : '3 pauses'),
                  subtitle: _activePatientId == 'patient-monalisa' ? 'Clock test velocity 0.18' : 'Clock test velocity 0.22',
                ...
                _buildKpiCard(
                  ...
                  value: '${stats.totalSessions > 0 ? stats.totalSessions : 7} Days',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_activePatientId == 'patient-tenzin') ...[
                _buildDomainProgressBar('Working Memory (Memory Match)', 0.80, '80%', const Color(0xFF1D4ED8), 'Visual spatial pairing'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Narrative Comprehension (Memory Story)', 0.78, '78%', const Color(0xFF7C3AED), 'Autobiographical story recall'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Visual Search (Spot the Difference)', 0.86, '86%', const Color(0xFF0D9488), 'Scene comparison & item recall'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Semantic Memory (Mother Tongue Naming)', 0.88, '88%', const Color(0xFF2563EB), 'Regional everyday object naming'),
                const SizedBox(height: 14),
              ...
              ] else if (_activePatientId == 'patient-monalisa') ...[
                _buildDomainProgressBar('Working Memory (Memory Match)', 0.74, '74%', const Color(0xFF1D4ED8), 'Visual spatial pairing'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Narrative Comprehension (Memory Story)', 0.88, '88%', const Color(0xFF7C3AED), 'Autobiographical story recall (strong)'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Visual Search (Spot the Difference)', 0.76, '76%', const Color(0xFF0D9488), 'Scene comparison & item recall'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Semantic Memory (Mother Tongue Naming)', 0.86, '86%', const Color(0xFF2563EB), 'Regional everyday object naming'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Visuoconstruction (Clock Contour & Hands)', 0.72, '7.2 / 10', const Color(0xFF4F46E5), 'Executive contour planning'),
                const SizedBox(height: 14),
                _buildDomainProgressBar('Kinematic Motor Tremor Neutralization', 0.92, '92 / 100', const Color(0xFF059669), 'Normal motor stability'),
              ] else ...[
