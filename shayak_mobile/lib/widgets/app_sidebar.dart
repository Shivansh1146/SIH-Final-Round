    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ListTile(
              leading: const Icon(Icons.format_size_rounded, color: AppTheme.forestGreen),
              title: const Text('Text Size Scaling'),
              subtitle: const Text('Comfortable 125% magnification active'),
              trailing: const Icon(Icons.check_circle_rounded, color: AppTheme.statusGreen),
            ),
            ListTile(
              leading: const Icon(Icons.contrast_rounded, color: AppTheme.forestGreen),
              title: const Text('High Contrast Outlines'),
              subtitle: const Text('2px clear borders on interactive elements'),
              trailing: const Icon(Icons.check_circle_rounded, color: AppTheme.statusGreen),
            ),
            ListTile(
              leading: const Icon(Icons.vibration_rounded, color: AppTheme.forestGreen),
              title: const Text('Tremor Dampening Filter'),
              subtitle: const Text('Active IMU low-pass sensor filter'),
              trailing: const Icon(Icons.check_circle_rounded, color: AppTheme.statusGreen),
            ),
          ],
        ),
